...
namespace WebClient.Services
{
    public class MemberDataService : IMemberDataService
    {
        ...
        public async Task<UpdateMemberCommandResult> Update(Guid id, UpdateMemberCommand command)
        {
            return await _httpClient.PutJsonAsync<UpdateMemberCommandResult>($"members/{id}", command);
        }
    }
}
